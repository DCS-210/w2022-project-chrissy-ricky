...
.pull-left[
```{r severity, echo = FALSE, out.width = "80%", fig.align = "center", fig.cap = "Reference: Mulinari T.O., et al. (2020). MDPI"}
...
for example, google search, twitter, facebook and other social media platform, 
may also be used to develop models and as early warning signals of COVID-19 outbreaks. 
Social media data can also presents with people's perception of risks 
and general mental states of a region. 
]
.pull-right[
```{r weather, echo = FALSE, out.width = "80%", fig.align = "center", fig.cap = "Reference: JHU Hub (2020)"}
...
.pull-left[
```{r vitaminD, echo = FALSE, out.width = "100%", fig.align = "center", fig.cap = "Reference: James G.. (2020)"}
...
.pull-left[
```{r vitaminD, echo = FALSE, out.width = "100%", fig.align = "center"}
include_graphics("www.aha.org/sites/default/files/2020-07/ms_072020_Machine_Learning_header_620_1624749.jpg")
```
]
.pull-right[
...
- These aim to assist medical staff worldwide in helping patients, especially in the context of limited healthcare resources.
]
...
Part II: Regression analyses, ranging from OLS, Diff in Diff, regression continuity

Part III: Advanced models and machine learning algorithnms
...
Development (HDI) and Total cases
...
c_map <- leaflet(data = cases_map) %>% 
  ...
  addPolygons(fillColor = ~pal2(cases_map$total_cases_per_million),
                                 ...
                                 weight = 1,
                                 label = labels) %>%
  addLegend("bottomleft", pal = pal2, values = ~deaths_map$total_deaths_per_million,
