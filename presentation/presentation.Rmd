...
---
```{r ARiMA_2, echo=FALSE, warning=FALSE, message = FALSE, out.width="90%", out.height="80%"}
...
---
```{r ARiMA_3, echo=FALSE, warning=FALSE, message = FALSE, out.width="90%", out.height="80%"}
...
---
# Results & Implications
```{r ARiMA_6, echo=FALSE, warning=FALSE, message = FALSE, out.width="90%", out.height="90%"}
...
# Results & Implications - What is kNN Algorithm?
