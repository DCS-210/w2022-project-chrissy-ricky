...
>>>>>>> 6610419aa8c720e2607f53bf396a088c110079ec
...
# Literature Review - [6: vitamin D and covi-19]
...
# Results & Implications [1a: preliminary analyses - summary statistics]

1. covid data (cases, death, vaccinations)
```{r cases-death-vaccination-1}
covid_data %>%
...
<<<<<<< HEAD
2. medical resources (handwashing facilities, hospital beds per thousand, ...)
```{r}

```

3. general health information (aged 70 and over, diabete prevalence, female & male smoker)
```{r}

```


4. development (life expectancy, HDI, population density, extreme poverty)
```{r}

```

5. stringency index (how strict)
```{r}
