...
.footnote[.small[
[1] Mudatsir, M. et al., (2021). Predictors of COVID-19 severity: A systematic review and meta-analysis
[2] Izcovich, A., et al., (2020). Prognostic factors for severity and mortality in patients infected with COVID-19: A systematic review
[3] Li, J., et al., (2021). Meta-analysis investigating the relationship between clinical features, outcomes, and severity of severe acute respiratory syndrome coronavirus 2 (SARS-CoV-2) pneumonia.
]
...
.footnote[.small[
[1] Chiodini, I., et al., (2021). Vitamin D status and SARS-COV-2 infection and COVID-19 clinical outcomes.  
]
...
.footnote[.small[
[1] Khan, A., et al., (2022). Interaction of temperature and relative humidity for growth of COVID-19 cases and death rates
[2] Azuma, K., et al.,  (2020). Impact of climate and ambient air pollution on the epidemic growth during COVID-19 outbreak in Japan
[3]Aboubakri, O., et al., (2022). Ambient temperature and covid-19 transmission: An evidence from a region of Iran based on weather station and satellite data. 
]
---
...
.footnote[.small[
[1] Yousefinaghani, S., et al., (2021). Prediction of covid-19 waves using social media and google search: A case study of the US and Canada. 
[2] Qin, Lei, et al., (2020). "Prediction of Number of Cases of 2019 Novel Coronavirus (COVID-19) Using Social Media Search Index"
[3] Hou, Z., et al., (2020). Assessment of public attention, risk perception, emotional and behavioural responses to the COVID-19 outbreak: Social media surveillance in China. 
]
...
.footnote[.small[
[1] Ray, R. L., et al., (2022). What is the impact of COVID-19 pandemic on global carbon emissions?   
[2] Lee, C.-K., et al., (2022). Impact of perception of covid-19 on NPI, job satisfaction, and customer orientation: Highlighting three types of npis for the airline industry. 
[3] Fernández-González, R., et al., (2022). Socio-economic impact of covid-19 on the fishing sector: A case study of a region highly dependent on fishing in Spain. 
]
...
.footnote[.small[
[1] Zoabi, Y., Deri-Rozov, S. & Shomron, N. (2021). Machine learning-based prediction of COVID-19 diagnosis based on symptoms.
[2] Xu, L., Magar, R., & Barati Farimani, A. (2022). Forecasting covid-19 new cases using Deep Learning Methods. 
[3] Chew, A. W., et al., (2021). Hybrid deep learning of social media big data for predicting the evolution of COVID-19 transmission. 
[4] Fritz, C., Dorigatti, E., & Rügamer, D. (2022). Combining graph neural networks and spatio-temporal disease models to improve the prediction of weekly COVID-19 cases in Germany.
]
...
covid_time <- covid_data %>%
  ...
  filter(location == c("China", "Japan", "India", "Brazil", "France", "Germany", "Italy", "Mexico", "Russia", "United Kingdom", "United States"))
...
ggplot(data = covid_time, aes(x = date, y = new_cases)) +
      ...
      labs(title = "Total Covid-19 cases in United States",
           subtitle = "by time",
...
covid_country %>%
  ...
  ggplot(aes(x = vaccination, y = new_deaths_per_million)) +
