...
covid_time <- covid_data %>%
  ...
  filter(location == c("Italy", "Japan", "France", "Germany", "United Kingdom", "Brazil", "India", "United States"))
...
```{r ARiMA_0, echo = FALSE, warning=FALSE}
library(TTR)
covid_time <- covid_data %>%
...
---
```{r ARiMA_1a, echo = FALSE, warning=FALSE, out.width="100%", out.height="60%"}
...
---
```{r ARiMA_1b, echo = FALSE, warning=FALSE, out.width="100%", out.height="60%"}
...
---
```{r ARiMA_2, echo=FALSE, warning=FALSE, out.width="100%", out.height="80%"}
...
---
```{r ARiMA_3, echo=FALSE, warning=FALSE, out.width="100%", out.height="80%"}
...
---
```{r ARiMA_4, echo=FALSE, warning=FALSE}
auto.arima(cases_diff)
```

---
```{r ARiMA_5, echo=FALSE, warning=FALSE}
covid_time_arima <- arima(covid_time$new_cases, order=c(2,0,2)) 
covid_time_arima
```

---
```{r ARiMA_6, echo=FALSE, warning=FALSE}
fit <- Arima(cases_diff, order=c(2,0,2))
```

---
```{r ARiMA_7, echo=FALSE, warning=FALSE}
checkresiduals(fit)
```

---
```{r ARiMA8, echo=FALSE, warning=FALSE }
...
```{r rdd1, echo=FALSE, warning=FALSE}
...
---
```{r rdd2, echo=FALSE, warning=FALSE}
covid_total <- covid_data %>%
  filter(date == "2022-02-20")
...
---
```{r rdd_plot2, echo=FALSE, warning=FALSE}
covid_country %>%
  select(vaccination, new_deaths_per_million) %>%
