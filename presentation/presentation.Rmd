...
```{r covid_cases_early_1, echo = FALSE, warning = FALSE, message=FALSE, fig.alt = "scatterplot of flipper length by bill length of 3 penguin species, where we show penguins with bigger flippers have bigger bills"}
...
---
# Early Covid-19 Cases
```{r covid_cases_early_2, echo = FALSE, warning = FALSE, message=FALSE, fig.alt = "scatterplot of flipper length by bill length of 3 penguin species, where we show penguins with bigger flippers have bigger bills"}
world <- ne_countries(scale = "medium", returnclass = "sf")
...
```{r HDI-map, echo = FALSE, warning = FALSE, message=FALSE, include=FALSE, out.height= "80%", out.width= "90%"}
HDI <- covid_data %>%
...
```{r death-map, echo = FALSE, warning = FALSE, message=FALSE, include=FALSE, out.height= "80%", out.width= "90%"}
death <- covid_data %>%
