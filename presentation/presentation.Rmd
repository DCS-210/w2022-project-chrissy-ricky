...
- .small[The unpredictability of the progression of coronavirus disease 2019 (COVID-19) may be attributed to the low precision of the tools used to predict the prognosis of this disease, especially when the virus is mutating in a fast speed from alpha, to Omicron, and there are more recent variants too.]
...
```{r}
# data <- covid_time_wide(
#   time=seq(date), 
#   value1=total_cases.China,
#   value2=total_cases.United_States
# )
# 
# don
